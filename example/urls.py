...
from .views import file_list, upload_file, delete_file,delete_directory,rename_file,rename_directory, shared_file_list, upload_shared_file, delete_shared_file,deletion_consent,read_consent,shared_key,new_directory,change_address,go_back, protected_serve
from .views import (
